...
def image_encode(args, item, q_out):
    try:
        ...
        img = io.imread(os.path.join(args.root, item[1]))
    except:
    ...
    try:
        s = mx.recordio.pack_img(header, img, quality=args.quality, img_fmt='.jpg')
        q_out.put((s, item))
    except Exception, e:
...
def parse_args():
    ...
    rgroup.add_argument('--center-crop', type=bool, default=True,
